...
<head>
    ...
    <title> @yield('title') | WebSite Clothes </title>
            ...
            <div class="container">
                <div class="ht-left">
                    <div class="mail-service">
                        ...
                        Thaiplbhaf200110@gmail.com
                    </div>
                    <div class="phone-service">
                        <i class="fa fa phone">+0369592257</i>
                    </div>
                </div>
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select class="language-drop" name="Countries" id="countries" style="...">
                            ...
                            <option value="yu" data-image="front/img/flag-2.jpg" data-imagecss="flag yu" data-title="English" >Vietnamese</option>
                        </select>
                    </div>
                    <div class="top-social">
                        <a href="#"><i class="li-facebook"></i></a>
                        <a href="#"><i class="li-twitter"></i></a>
                        <a href="#"><i class="li-instagram"></i></a>
                        <a href="#"><i class="li-youtube"></i></a>
                    </div>
                </div>
            </div>   
        </div>
            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="./index.html">
                                <img src="front/img/A1.png" height="80" alt="..">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 text-right col-md-3">
                        <ul class="nav-right">
                            ...
                            <li class="cart-price">$123.456</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            <li class="active"><a href="#">Women's Clothings</a></li>
                            <li><a href="#">Men's Clothing</a></li>
                            <li><a href="#">UnderWear</a></li>
                            <li><a href="#">Kid's Clothings</a></li>
...
<footer class="footer-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="#"><img src="front/img/badminton.jpg" height="180" alt=""></a>
                    </div>
                    <ul>
                        <li>HOAI DUC-HANOI</li>
                        <li>SDT : 0369592257</li>
                        <li>Email : thaiplbhaf2001100@fpt.edu.vn</li>
                    </ul>
            ...
            <div class="col-lg-4">
                <div class="newlatter-item">
                    <h5>Join Our Newletter</h5>
                    <p>Get Email update about ours latter shop and special effects</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-text">
                       Copyright <script>document.write(new Date().getFullYear());</script> All Right reserved | This Template                           
                    </div>
